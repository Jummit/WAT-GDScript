...
const Test: Script = preload("res://addons/third_party/WAT/core/test/test.gd")
const Case: Script = preload("res://addons/third_party/WAT/core/test/case.gd")
const Assertions: Script = preload("res://addons/third_party/WAT/core/assertions/assertions.gd")
const Parameters: Script = preload("res://addons/third_party/WAT/core/test/parameters.gd")
const Recorder: Script = preload("res://addons/third_party/WAT/core/test/recorder.gd")
const Watcher: Script = preload("res://addons/third_party/WAT/core/test/watcher.gd")
const Any: Script = preload("res://addons/third_party/WAT/core/test/any.gd")
const Director: Script = preload("res://addons/third_party/WAT/core/double/factory.gd")
const Registry: Script = preload("res://addons/third_party/WAT/core/double/registry.gd")
const Yielder: Script = preload("res://addons/third_party/WAT/core/test/yielder.gd")
